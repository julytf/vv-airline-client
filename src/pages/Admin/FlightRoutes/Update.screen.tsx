...
interface UpdateFlightRouteProps {}

const UpdateFlightRoute: FunctionComponent<UpdateFlightRouteProps> = () => {
  ...
  useEffect(() => {
    flightRoutesService.getFlightRoute(id).then((data) => {
      reset({
        distance: data.distance,
        prices: {
          [TicketClass.ECONOMY]: {
            [TicketType.BUDGET]: data.prices[TicketClass.ECONOMY][TicketType.BUDGET],
            [TicketType.STANDARD]: data.prices[TicketClass.ECONOMY][TicketType.STANDARD],
            [TicketType.FLEXIBLE]: data.prices[TicketClass.ECONOMY][TicketType.FLEXIBLE],
          },
          [TicketClass.BUSINESS]: {
            [TicketType.STANDARD]: data.prices[TicketClass.BUSINESS][TicketType.STANDARD],
            [TicketType.FLEXIBLE]: data.prices[TicketClass.BUSINESS][TicketType.FLEXIBLE],
          },
        },
    ...
    <div className='flex justify-center p-8'>
      <form method='post' className='max-w-2xl flex-1 rounded-md bg-white p-6' onSubmit={handleSubmit(onSubmit)}>
        <div className='mx-auto w-full max-w-sm pt-6'>
          <h2 className='text-center text-2xl font-bold leading-9 tracking-tight text-gray-900'>Cập nhật Tuyến bay</h2>
        </div>

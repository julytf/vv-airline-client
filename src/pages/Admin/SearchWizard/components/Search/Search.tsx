...
import { SearchData, useSearchWizard } from '@/contexts/SearchWizard.context'
...
const Search: FunctionComponent<SearchProps> = () => {
  ...
  const onSearch = () => {
    ...
    setData((prev) => {
      prev.searchData.departureAirportIATA = formData.departureAirportIATA!
      prev.searchData.arrivalAirportIATA = formData.arrivalAirportIATA!
  ...
  return (
    <div className='flex items-center justify-center'>
      <div className={classNames(' rounded-xl border-2 border-primary bg-white p-6')}>
